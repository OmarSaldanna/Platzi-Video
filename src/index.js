...
// datos del json para el storage de redux
const initialState = {
  "user": {},
  "playing": {},
  "mylist": [],
...
// funcion para escuchar redux en el navegador
const composeEnhancers = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose;

// creamos un store en redux con los datos del json
const store = createStore(reducer, initialState, composeEnhancers());

// montar la app
ReactDOM.render(
  // pasamos el store al provider
  <Provider store={store}>
    <App />
  </Provider>,

  // la app se montara en el div con id de app
